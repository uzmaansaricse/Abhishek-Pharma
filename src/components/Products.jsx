...
export default function Products() {
  ...
  const content = {
    ...
    hi: {
      ...
      humanDesc: 'विभिन्न चिकित्सा आवश्यकताओं के लिए गोलियां, कैप्सूल, सिरप, इंजेक्शन और तरल फॉर्मूलेशन सहित फार्मास्युटिकल उत्पादों की व्यापक श्रृंखला, प्रभावी उपचार और रोगी देखभाल सुनिश्चित करती है। हमारी एलोपैथिक दवाएं प्रमाणित निर्माताओं से प्राप्त की जाती हैं और सुरक्षा और प्रभावकारिता की गारंटी के लिए सख्त गुणवत्ता परीक्षण से गुजरती हैं।',
      surgical: 'शल्य चिकित्सा एवं उपभोग्य वस्तुएं',
      surgicalDesc: 'स्वास्थ्य सुविधाओं के लिए आवश्यक उच्च गुणवत्ता वाले चिकित्सा उपकरण, शल्य उपकरण, डिस्पोजेबल उत्पाद और उपभोग्य वस्तुएं, सुरक्षा और विश्वसनीयता के उच्चतम मानकों को बनाए रखती हैं। हम अंतरराष्ट्रीय मानकों को पूरा करने वाले बाँझ शल्य आपूर्ति और उपकरण प्रदान करते हैं।',
      veterinary: 'पशु चिकित्सा दवाएं',
      vetDesc: 'पशुधन और साथी जानवरों के लिए विशेष स्वास्थ्य समाधान, वैज्ञानिक रूप से तैयार उत्पादों और विशेषज्ञ पशु चिकित्सा देखभाल के माध्यम से इष्टतम स्वास्थ्य और कल्याण सुनिश्चित करते हैं। हमारी पशु चिकित्सा श्रृंखला में विभिन्न पशु प्रजातियों के लिए दवाएं शामिल हैं, पशुधन से लेकर पालतू जानवरों तक, निवारक और उपचारात्मक उपचारों पर ध्यान केंद्रित करती है।',
      ayurveda: 'आयुर्वेदिक उत्पाद',
      ayurvedaDesc: 'प्राचीन आयुर्वेदिक सिद्धांतों पर आधारित पारंपरिक हर्बल दवाएं, वेलनेस सप्लीमेंट और प्राकृतिक फॉर्मूलेशन, समग्र स्वास्थ्य और प्राकृतिक उपचार को बढ़ावा देते हैं। हमारे आयुर्वेदिक उत्पाद समय-परीक्षण हर्बल ज्ञान को आधुनिक विनिर्माण मानकों के साथ जोड़ते हैं।',
      generalItems: 'सामान्य चिकित्सा सामग्री',
      generalItemsDesc: 'IV कैनुला, सिरिंज, पट्टियां और अन्य महत्वपूर्ण स्वास्थ्य सेवा सहायक सहित आवश्यक चिकित्सा आपूर्ति, पेशेवर चिकित्सा उपयोग और रोगी आराम के लिए डिज़ाइन की गई हैं। हम स्वास्थ्य सेटिंग्स में स्वच्छता और सुरक्षा सुनिश्चित करने वाले डिस्पोजेबल चिकित्सा वस्तुओं की पूरी श्रृंखला प्रदान करते हैं।',
      categories: [
        {
          icon: FaPills,
